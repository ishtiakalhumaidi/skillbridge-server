...
-- CreateIndex
CREATE UNIQUE INDEX "TutorSubject_tutorId_categoryId_key" ON "TutorSubject"("tutorId", "categoryId");
...
-- AddForeignKey
ALTER TABLE "TutorSubject" ADD CONSTRAINT "TutorSubject_categoryId_fkey" FOREIGN KEY ("categoryId") REFERENCES "Category"("id") ON DELETE CASCADE ON UPDATE CASCADE;
